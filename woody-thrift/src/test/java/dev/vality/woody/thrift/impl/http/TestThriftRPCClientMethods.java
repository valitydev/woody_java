...
public class TestThriftRPCClientMethods {
    ...
    public void testClientMethods() throws TException, URISyntaxException {
        ...
        assertTrue(tRPCClient1.toString().startsWith("dev.vailty.woody.rpc.OwnerServiceSrv$Iface@"));
        assertTrue(tRPCClient2.toString().startsWith("dev.vailty.woody.rpc.OwnerServiceSrv$Iface@"));
