...
public class Simple implements org.apache.thrift.TBase<Simple, Simple._Fields>, java.io.Serializable, Cloneable, Comparable<Simple> {
    ...
    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new SimpleStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new SimpleTupleSchemeFactory();
    ...
    public void unsetIm_default() {
        __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __IM_DEFAULT_ISSET_ID);
    }

    /** Returns true if field im_default is set (has been assigned a value) and false otherwise */
    public boolean isSetIm_default() {
        return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __IM_DEFAULT_ISSET_ID);
    }

    public void setIm_defaultIsSet(boolean value) {
        __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __IM_DEFAULT_ISSET_ID, value);
    }
        ...
        switch (field) {
            case IM_DEFAULT:
                if (value == null) {
                    ...
                    setIm_default((java.lang.Short) value);
                }
                break;
    ...
    public int compareTo(Simple other) {
        ...
        lastComparison = java.lang.Boolean.compare(isSetIm_default(), other.isSetIm_default());
        if (lastComparison != 0) {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder sb = new java.lang.StringBuilder("Simple(");
        boolean first = true;
    ...
    private static class SimpleStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
        @Override
    ...
    private static class SimpleStandardScheme extends org.apache.thrift.scheme.StandardScheme<Simple> {
    ...
    private static class SimpleTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
        @Override
    ...
    private static class SimpleTupleScheme extends org.apache.thrift.scheme.TupleScheme<Simple> {
