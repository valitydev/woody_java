...
public class Complex implements org.apache.thrift.TBase<Complex, Complex._Fields>, java.io.Serializable, Cloneable, Comparable<Complex> {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Short, Simple> the_map; // required
    public @org.apache.thrift.annotation.Nullable Simple req_simp; // required
    public @org.apache.thrift.annotation.Nullable Simple opt_simp; // optional
    ...
    public Complex(
            short cp_default,
            short cp_required,
            java.util.Map<java.lang.Short, Simple> the_map,
            Simple req_simp) {
        this();
    ...
    public Complex(Complex other) {
        ...
        if (other.isSetThe_map()) {
            java.util.Map<java.lang.Short, Simple> __this__the_map = new java.util.HashMap<java.lang.Short, Simple>(other.the_map.size());
            for (java.util.Map.Entry<java.lang.Short, Simple> other_element : other.the_map.entrySet()) {

                java.lang.Short other_element_key = other_element.getKey();
                Simple other_element_value = other_element.getValue();

                java.lang.Short __this__the_map_copy_key = other_element_key;
    ...
    public void unsetCp_default() {
        __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __CP_DEFAULT_ISSET_ID);
    }

    /** Returns true if field cp_default is set (has been assigned a value) and false otherwise */
    public boolean isSetCp_default() {
        return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __CP_DEFAULT_ISSET_ID);
    }

    public void setCp_defaultIsSet(boolean value) {
        __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __CP_DEFAULT_ISSET_ID, value);
    }
    ...
    public void unsetCp_required() {
        __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __CP_REQUIRED_ISSET_ID);
    }

    /** Returns true if field cp_required is set (has been assigned a value) and false otherwise */
    public boolean isSetCp_required() {
        return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __CP_REQUIRED_ISSET_ID);
    }

    public void setCp_requiredIsSet(boolean value) {
        __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __CP_REQUIRED_ISSET_ID, value);
    }
    ...
    public void unsetCp_optional() {
        __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __CP_OPTIONAL_ISSET_ID);
    }

    /** Returns true if field cp_optional is set (has been assigned a value) and false otherwise */
    public boolean isSetCp_optional() {
        return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __CP_OPTIONAL_ISSET_ID);
    }

    public void setCp_optionalIsSet(boolean value) {
        __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __CP_OPTIONAL_ISSET_ID, value);
    }
    ...
    public void putToThe_map(short key, Simple val) {
        if (this.the_map == null) {
            this.the_map = new java.util.HashMap<java.lang.Short, Simple>();
        }
        this.the_map.put(key, val);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.Map<java.lang.Short, Simple> getThe_map() {
        return this.the_map;
    }

    public Complex setThe_map(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Short, Simple> the_map) {
        this.the_map = the_map;
        return this;
    }
    ...
    public Complex setReq_simp(@org.apache.thrift.annotation.Nullable Simple req_simp) {
        this.req_simp = req_simp;
        return this;
    }
    ...
    public Complex setOpt_simp(@org.apache.thrift.annotation.Nullable Simple opt_simp) {
        ...
        switch (field) {
            case CP_DEFAULT:
                if (value == null) {
                    ...
                    setCp_default((java.lang.Short) value);
                }
                break;
            ...
            case CP_REQUIRED:
                if (value == null) {
                    ...
                    setCp_required((java.lang.Short) value);
                }
                break;
            ...
            case CP_OPTIONAL:
                if (value == null) {
                    ...
                    setCp_optional((java.lang.Short) value);
                }
                break;
            ...
            case THE_MAP:
                if (value == null) {
                    ...
                    setThe_map((java.util.Map<java.lang.Short, Simple>) value);
                }
                break;
    ...
    public int compareTo(Complex other) {
        ...
        lastComparison = java.lang.Boolean.compare(isSetCp_default(), other.isSetCp_default());
        if (lastComparison != 0) {
        ...
        lastComparison = java.lang.Boolean.compare(isSetCp_required(), other.isSetCp_required());
        if (lastComparison != 0) {
            return lastComparison;
        }
        if (isSetCp_required()) {
        ...
        lastComparison = java.lang.Boolean.compare(isSetCp_optional(), other.isSetCp_optional());
        if (lastComparison != 0) {
            return lastComparison;
        }
        if (isSetCp_optional()) {
        ...
        lastComparison = java.lang.Boolean.compare(isSetThe_map(), other.isSetThe_map());
        if (lastComparison != 0) {
            return lastComparison;
        }
        if (isSetThe_map()) {
        ...
        lastComparison = java.lang.Boolean.compare(isSetReq_simp(), other.isSetReq_simp());
        if (lastComparison != 0) {
            return lastComparison;
        }
        if (isSetReq_simp()) {
        ...
        lastComparison = java.lang.Boolean.compare(isSetOpt_simp(), other.isSetOpt_simp());
        if (lastComparison != 0) {
            return lastComparison;
        }
        if (isSetOpt_simp()) {
                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                            {
                                ...
                                struct.the_map = new java.util.HashMap<java.lang.Short, Simple>(2 * _map18.size);
                                short _key19;
                                @org.apache.thrift.annotation.Nullable Simple _val20;
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, Complex struct) throws org.apache.thrift.TException {
            ...
            if (struct.the_map != null) {
                oprot.writeFieldBegin(THE_MAP_FIELD_DESC);
                {
                    ...
                    for (java.util.Map.Entry<java.lang.Short, Simple> _iter22 : struct.the_map.entrySet()) {
    ...
    private static class ComplexTupleScheme extends org.apache.thrift.scheme.TupleScheme<Complex> {
            ...
            if (struct.isSetThe_map()) {
                {
                    ...
                    for (java.util.Map.Entry<java.lang.Short, Simple> _iter23 : struct.the_map.entrySet()) {
        ...
        public void read(org.apache.thrift.protocol.TProtocol prot, Complex struct) throws org.apache.thrift.TException {
            ...
            if (incoming.get(2)) {
                {
                    org.apache.thrift.protocol.TMap _map24 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I16, org.apache.thrift.protocol.TType.STRUCT);
                    struct.the_map = new java.util.HashMap<java.lang.Short, Simple>(2 * _map24.size);
                    short _key25;
                    @org.apache.thrift.annotation.Nullable Simple _val26;
