...
public class TestUnion extends org.apache.thrift.TUnion<TestUnion, TestUnion._Fields> {
    ...
    public TestUnion(_Fields setField, java.lang.Object value) {
    ...
    public static TestUnion string_field(java.lang.String value) {
    ...
    public static TestUnion struct_list(java.util.List<RandomStuff> value) {
        TestUnion x = new TestUnion();
    ...
    public static TestUnion i32_set(java.util.Set<java.lang.Integer> value) {
        TestUnion x = new TestUnion();
        x.setI32_set(value);
        return x;
    }

    public static TestUnion i32_map(java.util.Map<java.lang.Integer, java.lang.Integer> value) {
        TestUnion x = new TestUnion();
        x.setI32_map(value);
        return x;
    }
    ...
    protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
        switch (setField) {
            case STRING_FIELD:
                ...
                throw new java.lang.ClassCastException("Was expecting value of type java.lang.String for field 'string_field', but got " + value.getClass().getSimpleName());
            case I32_FIELD:
                if (value instanceof java.lang.Integer) {
                    break;
                }
                throw new java.lang.ClassCastException("Was expecting value of type java.lang.Integer for field 'i32_field', but got " + value.getClass().getSimpleName());
            case STRUCT_FIELD:
                if (value instanceof OneOfEach) {
                    break;
                }
                throw new java.lang.ClassCastException("Was expecting value of type OneOfEach for field 'struct_field', but got " + value.getClass().getSimpleName());
            case STRUCT_LIST:
                if (value instanceof java.util.List) {
                    break;
                }
                throw new java.lang.ClassCastException("Was expecting value of type java.util.List<RandomStuff> for field 'struct_list', but got " + value.getClass().getSimpleName());
            case OTHER_I32_FIELD:
                if (value instanceof java.lang.Integer) {
                    break;
                }
                throw new java.lang.ClassCastException("Was expecting value of type java.lang.Integer for field 'other_i32_field', but got " + value.getClass().getSimpleName());
            case ENUM_FIELD:
                if (value instanceof SomeEnum) {
                    break;
                }
                throw new java.lang.ClassCastException("Was expecting value of type SomeEnum for field 'enum_field', but got " + value.getClass().getSimpleName());
            case I32_SET:
                if (value instanceof java.util.Set) {
                    break;
                }
                throw new java.lang.ClassCastException("Was expecting value of type java.util.Set<java.lang.Integer> for field 'i32_set', but got " + value.getClass().getSimpleName());
            case I32_MAP:
                if (value instanceof java.util.Map) {
                    break;
                }
                throw new java.lang.ClassCastException("Was expecting value of type java.util.Map<java.lang.Integer,java.lang.Integer> for field 'i32_map', but got " + value.getClass().getSimpleName());
            default:
            ...
            switch (setField) {
                ...
                case STRUCT_LIST:
                    if (field.type == STRUCT_LIST_FIELD_DESC.type) {
                        java.util.List<RandomStuff> struct_list;
                        {
                            org.apache.thrift.protocol.TList _list654 = iprot.readListBegin();
                            struct_list = new java.util.ArrayList<RandomStuff>(_list654.size);
                            @org.apache.thrift.annotation.Nullable RandomStuff _elem655;
                ...
                case OTHER_I32_FIELD:
                    if (field.type == OTHER_I32_FIELD_FIELD_DESC.type) {
                        java.lang.Integer other_i32_field;
                ...
                case I32_SET:
                    if (field.type == I32_SET_FIELD_DESC.type) {
                        java.util.Set<java.lang.Integer> i32_set;
                        {
                            ...
                            i32_set = new java.util.HashSet<java.lang.Integer>(2 * _set657.size);
                            int _elem658;
                ...
                case I32_MAP:
                    if (field.type == I32_MAP_FIELD_DESC.type) {
                        java.util.Map<java.lang.Integer, java.lang.Integer> i32_map;
                        {
                            ...
                            i32_map = new java.util.HashMap<java.lang.Integer, java.lang.Integer>(2 * _map660.size);
                            int _key661;
                            int _val662;
    ...
    protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
        switch (setField_) {
            case STRING_FIELD:
                java.lang.String string_field = (java.lang.String) value_;
                oprot.writeString(string_field);
                return;
            case I32_FIELD:
                java.lang.Integer i32_field = (java.lang.Integer) value_;
            ...
            case STRUCT_FIELD:
                ...
                return;
            case STRUCT_LIST:
                java.util.List<RandomStuff> struct_list = (java.util.List<RandomStuff>) value_;
            {
            ...
            return;
            case OTHER_I32_FIELD:
                java.lang.Integer other_i32_field = (java.lang.Integer) value_;
            ...
            case ENUM_FIELD:
                ...
                return;
            case I32_SET:
                java.util.Set<java.lang.Integer> i32_set = (java.util.Set<java.lang.Integer>) value_;
            {
            ...
            return;
            case I32_MAP:
                java.util.Map<java.lang.Integer, java.lang.Integer> i32_map = (java.util.Map<java.lang.Integer, java.lang.Integer>) value_;
            {
                ...
                for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter666 : i32_map.entrySet()) {
        ...
        if (setField != null) {
            switch (setField) {
                    ...
                    java.util.List<RandomStuff> struct_list;
                {
                    ...
                    struct_list = new java.util.ArrayList<RandomStuff>(_list667.size);
                    @org.apache.thrift.annotation.Nullable RandomStuff _elem668;
                    ...
                    java.util.Set<java.lang.Integer> i32_set;
                {
                    ...
                    i32_set = new java.util.HashSet<java.lang.Integer>(2 * _set670.size);
                    int _elem671;
                    ...
                    java.util.Map<java.lang.Integer, java.lang.Integer> i32_map;
                {
                    ...
                    i32_map = new java.util.HashMap<java.lang.Integer, java.lang.Integer>(2 * _map673.size);
                    int _key674;
                    int _val675;
    ...
    protected void tupleSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
        switch (setField_) {
            ...
            {
                oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.I32, i32_map.size()));
                for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter679 : i32_map.entrySet()) {
    ...
    public java.lang.String getString_field() {
        if (getSetField() == _Fields.STRING_FIELD) {
            ...
            throw new java.lang.RuntimeException("Cannot get field 'string_field' because union is currently set to " + getFieldDesc(getSetField()).name);
        }
    }
     ...
     * A doc string
     */
    public void setString_field(java.lang.String value) {
        setField_ = _Fields.STRING_FIELD;
        value_ = java.util.Objects.requireNonNull(value, "_Fields.STRING_FIELD");
    }
    ...
    public int getI32_field() {
        if (getSetField() == _Fields.I32_FIELD) {
            ...
            throw new java.lang.RuntimeException("Cannot get field 'i32_field' because union is currently set to " + getFieldDesc(getSetField()).name);
        }
    }
    ...
    public java.util.List<RandomStuff> getStruct_list() {
        if (getSetField() == _Fields.STRUCT_LIST) {
            return (java.util.List<RandomStuff>) getFieldValue();
        } else {
            throw new java.lang.RuntimeException("Cannot get field 'struct_list' because union is currently set to " + getFieldDesc(getSetField()).name);
        }
    }

    public void setStruct_list(java.util.List<RandomStuff> value) {
        setField_ = _Fields.STRUCT_LIST;
        value_ = java.util.Objects.requireNonNull(value, "_Fields.STRUCT_LIST");
    }
    ...
    public int getOther_i32_field() {
        if (getSetField() == _Fields.OTHER_I32_FIELD) {
            ...
            throw new java.lang.RuntimeException("Cannot get field 'other_i32_field' because union is currently set to " + getFieldDesc(getSetField()).name);
        }
    }
    ...
    public SomeEnum getEnum_field() {
        if (getSetField() == _Fields.ENUM_FIELD) {
            ...
            throw new java.lang.RuntimeException("Cannot get field 'enum_field' because union is currently set to " + getFieldDesc(getSetField()).name);
        }
    }
    ...
    public void setEnum_field(SomeEnum value) {
        ...
        value_ = java.util.Objects.requireNonNull(value, "_Fields.ENUM_FIELD");
    }

    public java.util.Set<java.lang.Integer> getI32_set() {
        if (getSetField() == _Fields.I32_SET) {
            return (java.util.Set<java.lang.Integer>) getFieldValue();
        } else {
            throw new java.lang.RuntimeException("Cannot get field 'i32_set' because union is currently set to " + getFieldDesc(getSetField()).name);
        }
    }

    public void setI32_set(java.util.Set<java.lang.Integer> value) {
        setField_ = _Fields.I32_SET;
        value_ = java.util.Objects.requireNonNull(value, "_Fields.I32_SET");
    }

    public java.util.Map<java.lang.Integer, java.lang.Integer> getI32_map() {
        if (getSetField() == _Fields.I32_MAP) {
            return (java.util.Map<java.lang.Integer, java.lang.Integer>) getFieldValue();
        } else {
            throw new java.lang.RuntimeException("Cannot get field 'i32_map' because union is currently set to " + getFieldDesc(getSetField()).name);
        }
    }

    public void setI32_map(java.util.Map<java.lang.Integer, java.lang.Integer> value) {
        setField_ = _Fields.I32_MAP;
        value_ = java.util.Objects.requireNonNull(value, "_Fields.I32_MAP");
    }
