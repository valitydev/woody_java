...
public class TestUnionMinusStringField extends org.apache.thrift.TUnion<TestUnionMinusStringField, TestUnionMinusStringField._Fields> {
    ...
    public TestUnionMinusStringField(_Fields setField, java.lang.Object value) {
    ...
    public static TestUnionMinusStringField struct_list(java.util.List<RandomStuff> value) {
        TestUnionMinusStringField x = new TestUnionMinusStringField();
    ...
    public static TestUnionMinusStringField i32_set(java.util.Set<java.lang.Integer> value) {
        TestUnionMinusStringField x = new TestUnionMinusStringField();
        x.setI32_set(value);
        return x;
    }

    public static TestUnionMinusStringField i32_map(java.util.Map<java.lang.Integer, java.lang.Integer> value) {
        TestUnionMinusStringField x = new TestUnionMinusStringField();
        x.setI32_map(value);
        return x;
    }
                ...
                case STRUCT_LIST:
                    if (field.type == STRUCT_LIST_FIELD_DESC.type) {
                        java.util.List<RandomStuff> struct_list;
                        {
                            ...
                            struct_list = new java.util.ArrayList<RandomStuff>(_list680.size);
                            @org.apache.thrift.annotation.Nullable RandomStuff _elem681;
                ...
                case I32_SET:
                    if (field.type == I32_SET_FIELD_DESC.type) {
                        java.util.Set<java.lang.Integer> i32_set;
                        {
                            ...
                            i32_set = new java.util.HashSet<java.lang.Integer>(2 * _set683.size);
                            int _elem684;
                ...
                case I32_MAP:
                    if (field.type == I32_MAP_FIELD_DESC.type) {
                        java.util.Map<java.lang.Integer, java.lang.Integer> i32_map;
                        {
                            ...
                            i32_map = new java.util.HashMap<java.lang.Integer, java.lang.Integer>(2 * _map686.size);
                            int _key687;
                            int _val688;
    ...
    protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
        switch (setField_) {
                ...
                java.util.Map<java.lang.Integer, java.lang.Integer> i32_map = (java.util.Map<java.lang.Integer, java.lang.Integer>) value_;
            {
                ...
                for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter692 : i32_map.entrySet()) {
        ...
        if (setField != null) {
            switch (setField) {
                    ...
                    java.util.List<RandomStuff> struct_list;
                {
                    ...
                    struct_list = new java.util.ArrayList<RandomStuff>(_list693.size);
                    @org.apache.thrift.annotation.Nullable RandomStuff _elem694;
                    ...
                    java.util.Set<java.lang.Integer> i32_set;
                {
                    ...
                    i32_set = new java.util.HashSet<java.lang.Integer>(2 * _set696.size);
                    int _elem697;
                    ...
                    java.util.Map<java.lang.Integer, java.lang.Integer> i32_map;
                {
                    ...
                    i32_map = new java.util.HashMap<java.lang.Integer, java.lang.Integer>(2 * _map699.size);
                    int _key700;
                    int _val701;
    ...
    protected void tupleSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
        switch (setField_) {
            ...
            {
                oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.I32, i32_map.size()));
                for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter705 : i32_map.entrySet()) {
