...
public interface RequestInterceptor extends Interceptor {
    /**
     * @return true - if request is successfully intercepted and ready for further processing;
     *      false - if interception failed and processing must be switched to request err handling
     */
